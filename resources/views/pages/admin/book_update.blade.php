                ...
                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" novalidate>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="book_authors" class="form-control" value="{{  $book->authors  }}" placeholder="John Doe, El Ray, ...">
                      </div>
                      
                      <div class="mb-3">
                        {{Form::label('book_genres', 'Genres:')}} 
                        <input type="text" name="book_genres" class="form-control" value="{{  $book->genres  }}" placeholder="romance, adventure, ...">
                      </div>
